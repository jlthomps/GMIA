...
library(GSqwsr)
dataMerge <- dataMerge[which(!is.na(dataMerge$Eglycol)),]
...
data_sub_cens <- importQW(data_sub,keep=keepAll,"Eglycol","rEGlycol","",0.0000002,"User","kg","Unk","","91075","EGlycolcens")
siteName <- "GMIAEGlycol"
siteNo <- '040871475'
...
investigateResponse <- "EGlycolcens"
