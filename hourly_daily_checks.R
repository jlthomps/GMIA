...
dailyGHCND <- read.csv("C:/Users/jlthomps/Desktop/git/GMIA/345840.csv",header=TRUE,stringsAsFactors=FALSE,strip.white=TRUE)
dailyGHCND <- dailyGHCND[,c(1:4,9,14,34,74,79,84,89,94,99,104,109,114,119,124,129,134,139,144,149,154,159,164,169)]
colnames(dailyGHCND) <- c("Station","StationName","Date","Precip","SnowDepth","SnowFall","SnowWaterEq","BlowingSnow","Drizzle","DustOrSand","Fog","FrzDrzl","FrzRain","Glaze","GrndFog","Hail","HeavyFog","HighWinds","IceFog","Sleet","Mist","Rain","Smoke","Snow","Thunder","Tornado","UnkPrecip")
