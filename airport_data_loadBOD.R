...
data_subPre <- data_sub[which(data_sub$bpdate<strftime("2000-01-01","%Y-%m-%d")),]
data_subPost <- data_sub[which(data_sub$bpdate>=strftime("2000-01-01","%Y-%m-%d")),]


####Pre
data_sub_cens <- importQW(data_subPre,c("Qmax","Eduration","mean_temp","max_temp","min_temp","prcp_sum","kgGlycol","decYear","sinDY","cosDY"),"BODload","remark","",0.005,"User","tons","Unk","","00310","BODLoading")
...
####Post
data_sub_cens <- importQW(data_subPost,c("Qmax","Eduration","mean_temp","max_temp","min_temp","prcp_sum","kgGlycol","decYear","sinDY","cosDY"),"BODload","remark","",0.005,"User","tons","Unk","","00310","BODLoading")
