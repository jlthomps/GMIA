...
pdf(fileName <- paste(pathToSave,"/","StLukesAllFinal","Residuals.pdf",sep=""))
...
pdf(fileName <- paste(pathToSave,"/","StLukesAllFinal","ResidualsBoxPlot.pdf",sep=""))
boxplot(residsdf,ylab="Model residual",main="Residuals for St Lukes split into groups at 10/01/02 and 10/01/05",col=c("red","blue","green","red","blue","green","red","blue","green"),las=2,at=c(1,2,3,5,6,7,9,10,11),par(mar=c(12,5,4,2)+0.1))
dev.off()
